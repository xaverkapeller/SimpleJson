...
public class ImplementationBuilder {
    ...
    public ImplementationResult build() throws IOException {
        ...
        final String implClassName = modelType.className() + "$Impl";
        ...
        implementedTypes.add(modelType);
        ...
        for (Element element : mElement.getEnclosedElements()) {
            if (element.getKind() == ElementKind.METHOD) {
                ...
                mappedValues.add(new MappedValue(key, itemType, optional, valueType, method));
                fieldList.add(field);

                implBuilder.addMethod(finalReturnType, name, modifiers, new ExecutableBuilder() {
                    @Override
        ...
        return new ImplementationResult(implType, mappedValues);
    }
}
