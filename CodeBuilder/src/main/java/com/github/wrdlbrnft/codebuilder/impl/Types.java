...
public class Types {
    ...
    public static final Type LIST = create("java.util", "List", EnumSet.of(Modifier.PUBLIC), null);
    public static final Type SET = create("java.util", "Set", EnumSet.of(Modifier.PUBLIC), null);
    public static final Type MAP = create("java.util", "Map", EnumSet.of(Modifier.PUBLIC), null);
    public static final Type CLASS = create("java.lang", "Class", EnumSet.of(Modifier.PUBLIC), OBJECT);
    public static final Type HASH_SET = create("java.util", "HashSet", EnumSet.of(Modifier.PUBLIC), SET);
    public static final Type ARRAY_LIST = create("java.util", "ArrayList", EnumSet.of(Modifier.PUBLIC), LIST);
