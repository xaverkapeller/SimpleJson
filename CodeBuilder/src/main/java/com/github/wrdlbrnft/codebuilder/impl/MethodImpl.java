...
class MethodImpl extends ExecutableImpl implements Method {
    ...
    public MethodImpl(Type returnType, String name, List<Variable> parameters, Set<Modifier> modifiers, List<Type> exceptions) {
        super(modifiers, parameters, exceptions);
