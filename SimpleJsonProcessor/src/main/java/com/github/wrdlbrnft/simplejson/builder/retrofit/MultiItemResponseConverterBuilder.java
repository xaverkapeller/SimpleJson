...
class MultiItemResponseConverterBuilder extends BaseResponseConverterBuilder {

    private static final String CLASS_NAME = "SimpleJsonMultiItemResponseBodyConverter";

    private final ProcessingEnvironment mProcessingEnvironment;
    private final Type mConverterType;
    private final Type mResponseBodyType;

    public MultiItemResponseConverterBuilder(ProcessingEnvironment processingEnvironment, Type converterType, Type responseBodyType) {
    ...
    public Type build(String packageName) throws IOException {
        ...
        final Implementation implementation = new Implementation.Builder()
                ...
                .addImplementedType(Types.generic(mConverterType, mResponseBodyType, Types.generic(Types.LIST, typeParameter)))
                ...
                .addMethod(new Method.Builder()
                        .setName("convert")
                        .setModifiers(EnumSet.of(Modifier.PUBLIC))
                        .setReturnType(Types.generic(Types.LIST, typeParameter))
                        ...
                        .setCode(new ExecutableBuilder() {
                            ...
                            protected void write(Block block) {
                                ...
                                block.append("return ").append(InternalParserBuilder.METHOD_STUB_FROM_JSON_ARRAY.callOnTarget(parserField, varJson)).append(";");
                            }
                        })
                        .build())
                .build();
