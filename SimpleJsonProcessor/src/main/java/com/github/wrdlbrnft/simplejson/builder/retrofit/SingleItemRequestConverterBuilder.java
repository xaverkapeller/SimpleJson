...
class SingleItemRequestConverterBuilder extends BaseRequestConverterBuilder {

    private static final String CLASS_NAME = "SimpleJsonSingleItemRequestBodyConverter";
    private final ProcessingEnvironment mProcessingEnvironment;
    private final Type mConverterType;
    private final Type mMediaTypeType;
    private final Type mRequestBodyType;

    public SingleItemRequestConverterBuilder(ProcessingEnvironment processingEnvironment, Type converterType, Type mediaTypeType, Type requestBodyType) {
    ...
    public Type build(String packageName) throws IOException {
        ...
        final Implementation implementation = new Implementation.Builder()
                ...
                .addImplementedType(Types.generic(mConverterType, typeParameter, mRequestBodyType))
                ...
                .addMethod(new Method.Builder()
                        ...
                        .setCode(new ExecutableBuilder() {
                            ...
                            protected List<Variable> createParameters() {
                                final List<Variable> parameters = new ArrayList<>();
                                parameters.add(paramEntity = Variables.of(typeParameter));
                                return parameters;
                            }
                            ...
                            protected void write(Block block) {
                                ...
                                block.set(varJson, InternalParserBuilder.METHOD_STUB_TO_JSON.callOnTarget(parserField, paramEntity)).append(";").newLine();
